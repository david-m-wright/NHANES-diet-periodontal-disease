...
The distribution of the proportion of sites with CAL$\geq$3mm was strongly right skewed; the median number of sites showing  CAL $\geq3mm$ was `r median(nh$CAL_sites3mm)`.     
...
```{r overall predictions from beta regression, echo = FALSE}
