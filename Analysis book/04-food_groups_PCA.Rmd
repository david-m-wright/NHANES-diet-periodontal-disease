...
```{r PC-loading-plots-filtered, fig.height=11, fig.width=7}
...
ggplot(aes(x = Variable, y = Value)) +
  ...
  coord_flip() + 
  theme_light() +
  ggtitle("PC loading plot for analysis of food group intake with small loadings removed (|values|<0.1)")
```
